...
7. OBLIGATORIO — PROMPT SIEMPRE PRESENTE: El campo "prompt_agent" es OBLIGATORIO para TODOS los cambios sin excepción, independientemente de su prioridad (CRÍTICO, IMPORTANTE, etc.). Si no tienes suficiente contexto para generar un prompt completo, genera uno mínimo con este formato: "[DEEP][MODIFICAR] En <ruta_archivo>, <descripción breve del cambio pedido>. Revisar manualmente para completar detalles." NUNCA dejes prompt_agent vacío, null, o como string vacío.`;
